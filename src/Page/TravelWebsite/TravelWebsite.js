  ...
  return (
    <div className={style.main}>
      ...
      <div className={style.container}>
        <div>
          <h1>Travel Website Development Services</h1>
          <p>
            We offer expert Travel Website Development Services, creating
            captivating and user-friendly platforms to enhance travel
            businesses. Unlock your online potential with our customized
            solutions.
          </p>
          <button
            type="submit"
