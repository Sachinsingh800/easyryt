...
function MobileAppTestingandTestingQualityAssurance() {
  ...
  return (
    <div className={style.main}>
      <Helmet>
  <title>Mobile App Testing Experts</title>
  <meta charSet="utf-8" />
  <meta
    name="Mobile App Testing Experts"
    content="Ensure flawless performance with our thorough mobile app testing services. Deliver excellence to your users."
  />
</Helmet>
      <NavBar />
      <div className={style.container}>
        ...
        <div>
          <img className={style.img} src={img} alt="Mobile Application Testing Services" />
        </div>
      </div>
      <Section />
      <Section2 />
