    ...
    <div className={style.main}>
      ...
      <div className={style.container}>
        <div>
          ...
          <p>
            Expert iOS UI/UX design services creating intuitive and visually
            appealing mobile app experiences. Streamlined navigation, stunning
            visuals, and seamless interactions for optimal user engagement and
            satisfaction.
          </p>
