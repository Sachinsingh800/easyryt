    ...
    <div className={style.main}>
      ...
      <div className={style.container}>
        <div>
          ...
          <p>
            We offer expert Web Application Development Services, creating
            custom solutions to meet your business needs, delivering seamless
            user experiences and cutting-edge functionalities.
          </p>
          <button
            type="submit"
